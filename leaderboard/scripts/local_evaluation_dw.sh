...
export WORK_DIR=${2:-/home/wei/carla_garage}
...
export CHECKPOINT_ENDPOINT=${WORK_DIR}/result/004_so128_op_7/longest6.json
export TEAM_AGENT=${WORK_DIR}/team_code/sensor_agent.py
export TEAM_CONFIG=${WORK_DIR}/result/004_so128_op_7
export DEBUG_CHALLENGE=0
export RESUME=1
export DATAGEN=0
export SAVE_PATH=${WORK_DIR}/result/004_so128_op_7
